...
-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('CASH', 'VNPAY', 'MOMO', 'ZALOPAY', 'BANK_TRANSFER');
...
-- AddForeignKey
ALTER TABLE "Booking" ADD CONSTRAINT "Booking_comboId_fkey" FOREIGN KEY ("comboId") REFERENCES "Combo"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
